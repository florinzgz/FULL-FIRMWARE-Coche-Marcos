...
bool RenderEngine::createSprite(SpriteID id, int w, int h) {
  ...
  // Note: TFT_eSprite doesn't support setTransparentColor() method
  // Transparency is handled differently in the TFT_eSPI library
  // The steering layer uses fillSprite with TFT_BLACK as background
