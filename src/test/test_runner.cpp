...
bool runPreDeploymentTests() {
  ...
  totalTests +=
      FunctionalTests::getPassedCount() + FunctionalTests::getFailedCount();
  ...
  totalTests +=
      MemoryStressTest::getPassedCount() + MemoryStressTest::getFailedCount();
  ...
  totalTests += HardwareFailureTests::getPassedCount() +
                HardwareFailureTests::getFailedCount();
  ...
  totalTests +=
      WatchdogTests::getPassedCount() + WatchdogTests::getFailedCount();
...
void printOverallSummary() {
  ...
  if (totalFailed == 0 && totalTests > 0) {
    ...
    Logger::info(
        "║  2. Complete sign-off checklist in DEPLOYMENT_TESTING_GUIDE.md ║");
    Logger::info(
    ...
    Logger::warn(
        "║                                                            ║");
    Logger::warn(
        "║  Enable test modules in platformio.ini to run tests       ║");
    Logger::warn(
        "╚════════════════════════════════════════════════════════════╝");
  } else {
    Logger::error(
