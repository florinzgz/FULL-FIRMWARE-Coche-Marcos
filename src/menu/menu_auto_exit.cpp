...
void MenuAutoExit::resetTimer() { lastActivityTime = millis(); }
...
void MenuAutoExit::disable() { enabled = false; }

bool MenuAutoExit::isEnabled() { return enabled; }
...
uint8_t MenuAutoExit::getTimeoutSeconds() { return timeoutSeconds; }
...
void MenuAutoExit::setPIN(uint16_t pin) { protectionPIN = pin; }

uint16_t MenuAutoExit::getPIN() { return protectionPIN; }
