...
constexpr uint8_t DISPLAY_BRIGHTNESS_DEFAULT =
    200; // Default brightness (200 of 255)

// ======================================================
// Comprobaciones en tiempo de compilación
static_assert(TEMP_WARN_MOTOR < TEMP_MAX_MOTOR,
              "TEMP_WARN_MOTOR must be less than TEMP_MAX_MOTOR");
...
static_assert(REGEN_DEFAULT >= 0 && REGEN_DEFAULT <= 100,
              "REGEN_DEFAULT must be 0..100");