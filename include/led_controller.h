...
// ⚠️ IMPORTANTE: Los pines de LEDs se definen en pins.h como PIN_LED_FRONT y
// PIN_LED_REAR No redefinir aquí para evitar conflictos ✅ v2.12.0:
// PIN_LED_FRONT en GPIO 19 (sin cambios desde v2.4.1)
...
#define LED_REAR_COUNT                                                         \
  NUM_LEDS_REAR // Number of rear LEDs (16: 3 left + 10 center + 3 right)
...
constexpr uint8_t BRIGHTNESS_POSITION_LIGHTS =
    51;                                  // 20% brightness for position lights
...
constexpr uint16_t EMERGENCY_FLASH_INTERVAL_MS =
    100; // Emergency flash toggle interval
...
// Non-blocking: call startEmergencyFlash() to begin, update() handles the
// animation
