...
public:
  ...
  static bool saveAll(EncoderConfig &, SensorStates &, PowerConfig &,
                      LEDConfig &, GeneralSettings &);
  static bool loadAll(EncoderConfig &, SensorStates &, PowerConfig &,
                      LEDConfig &, GeneralSettings &);
