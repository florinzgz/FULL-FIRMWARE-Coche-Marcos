...
// Ver docs/AUDIO_TRACKS_GUIDE.md para textos sugeridos e instrucciones de
// grabación
enum Track : uint16_t {
  // ============================================
  // TRACKS BÁSICOS (1-38)
  ...
  AUDIO_ENCODER_ERROR =
      9, // Error en el sensor de dirección. Compruebe el encoder.
  ...
  // Batería
  AUDIO_BATERIA_BAJA =
      12, // Nivel de batería bajo. Conecte el cargador, por favor.
  AUDIO_BATERIA_CRITICA =
      13, // Advertencia. Batería en nivel crítico. Desconectando tracción.
  ...
  AUDIO_CAL_PEDAL = 26, // Iniciando calibración del pedal. Presione lentamente
                        // hasta el fondo.
  AUDIO_CAL_INA = 27, // Calibrando sensores de corriente. Espere unos segundos.
  AUDIO_CAL_ENCODER =
      28, // Calibrando el punto central del volante. Manténgalo recto.
  ...
  AUDIO_SENSOR_VELOCIDAD_ERROR =
      35, // Sin señal de velocidad. Revise sensores de rueda.
  ...
  AUDIO_OTA_INICIADO =
      47, // Actualización remota iniciada. No desconecte el vehículo.
  ...
  AUDIO_BT_EMPAREJANDO = 51,  // Buscando mando Bluetooth. Mantenga pulsado el
  ...
  AUDIO_BATERIA_25 =
      58, // Nivel de batería al 25 por ciento. Considere recargar.
