...
namespace AdaptiveCruise {
    ...
    struct ACCConfig {
        ...
        ACCConfig() : enabled(false), targetDistanceMm(1500), minDistanceMm(500),
    ...
    struct ACCStatus {
        ...
        ACCStatus() : state(ACC_DISABLED), currentDistance(0xFFFF), 
                     speedAdjustment(1.0f), vehicleDetected(false), lastUpdateMs(0) {}
    };
