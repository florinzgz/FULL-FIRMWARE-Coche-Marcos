...
// These functions help avoid reserved, strapping, and JTAG pins for general
// use.
// ============================================================================
 ...
 */
static inline bool pin_is_valid_gpio(uint8_t gpio) { return gpio <= 48; }
 ...
 *
 * Same as pin_is_safe_input() since ESP32-S3 has no input-only GPIO
 * restrictions. and reserved/strapping pins.
 *
 * @param gpio GPIO number to check
