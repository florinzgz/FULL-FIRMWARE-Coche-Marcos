...
namespace ObstacleLogger {
    ...
    struct LogEntry {
        ...
        LogEntry() : timestamp(0), sensorId(0), minDistance(0xFFFF),
    ...
    struct LoggerConfig {
        ...
        LoggerConfig() : enabled(false), autoRotate(true),
    ...
    struct LoggerStatus {
        ...
        LoggerStatus() : active(false), entriesLogged(0), currentFileSize(0),
                        filesCreated(0), lastLogMs(0) {}
    };
