...
// * El menú permite calibrar pedal, encoder, ajustar regen, activar/desactivar
// módulos,
//   guardar configuración, restaurar valores de fábrica y gestionar errores
//   persistentes.
...
// * Se apoya en Storage (guardar/restaurar), Audio (confirmaciones sonoras) y
// System (errores).
} // namespace MenuHidden