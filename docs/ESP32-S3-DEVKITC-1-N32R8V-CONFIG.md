# ESP32-S3-DevKitC-1 N32R8V Configuration

## Overview

This document describes the configuration for ESP32-S3-DevKitC-1 board with N32R8V variant (32MB Flash, 8MB PSRAM) added to the platformio.ini file.
...
Location: `boards/esp32-s3-devkitc1-n32r8v.json`
...
- This configuration is appropriate for ESP32-S3-DevKitC-1 boards with the N32R8V module
...
- **Board definition:** `boards/esp32-s3-devkitc1-n32r8v.json`
...
1. Verify your hardware has the N32R8V module (32MB Flash + 8MB PSRAM)
